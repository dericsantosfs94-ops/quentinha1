...
export default function Home() {
  ...
  if (menuQuery.isError) return <div className="flex min-h-screen flex-col items-center justify-center bg-[#fff8ef] px-5 text-center"><img src="https://xuzfsdvzgxaqspheifla.supabase.co/storage/v1/object/public/menu-products/branding/cantina-do-chale-logo.png" alt="Cantina do Chalé" className="h-20 w-20 rounded-full" /><h1 className="font-display mt-5 text-3xl text-[#8b1e23]">O cardápio não carregou</h1><p className="mt-2 max-w-sm text-[#765e54]">Tente novamente ou fale com a Cantina pelo WhatsApp.</p><button onClick={() => menuQuery.refetch()} className="breathe mt-5 rounded-full bg-[#ff6b35] px-5 py-3 font-extrabold text-[#2b211d]">Tentar novamente</button></div>;
  ...
  return (
    <div className="paper-texture min-h-screen pb-24">
      ...
      <main className="mx-auto max-w-6xl px-5 sm:px-8">
        ...
        <section id="onde-estamos" className="mt-16 grid gap-5 pb-14 lg:grid-cols-[.85fr_1.15fr]"><div className="rounded-[1.8rem] bg-[#8b1e23] p-7 text-white"><p className="text-xs font-extrabold uppercase tracking-[.2em] text-[#f2b84b]">Onde estamos</p><h2 className="font-display mt-3 text-2xl leading-tight sm:text-3xl">Rua Malvino Ferreira de Andrade, 689 — Santo Aleixo, Magé — RJ</h2><p className="mt-3 text-sm leading-6 text-white/75">Venha buscar seu pedido ou fale com a gente para combinar a entrega.</p><div className="mt-5 flex items-center gap-2 text-sm font-bold"><MapPin size={18} className="text-[#f2b84b]" />Cantina do Chalé</div></div><div className="rounded-[1.8rem] border border-[#ead5c1] bg-white p-7"><div className="flex flex-wrap items-start justify-between gap-3"><div><p className="text-xs font-extrabold uppercase tracking-[.2em] text-[#ff6b35]">Atendimento</p><h2 className="font-display mt-3 text-3xl text-[#8b1e23]">Do nosso jeito</h2></div><div className="flex items-center gap-2 rounded-full bg-[#fff0dc] px-3 py-2 text-xs font-extrabold text-[#8b1e23]"><Truck size={16} className="text-[#ff6b35]" />Área de entrega</div></div><div className="mt-5 grid gap-4 text-sm text-[#765e54] sm:grid-cols-[.7fr_1.3fr]"><div className="space-y-3"><div className="flex items-center gap-3"><Clock3 size={18} className="text-[#ff6b35]" />Consulte o horário pelo WhatsApp</div><div className="flex items-center gap-3"><ShoppingBag size={18} className="text-[#ff6b35]" />Entrega ou retirada na loja</div></div><div className="rounded-2xl bg-[#fff8ef] p-4"><p className="text-xs font-extrabold uppercase tracking-[.16em] text-[#ff6b35]">Atendemos nestas áreas</p><div className="mt-3 flex flex-wrap gap-2">{["Batatal", "Cavado", "Ponte Ezequiel", "Andorinhas", "Poço Escuro", "Paineira", "Centro", "Chalé", "Picos 1 e 2", "Santo Aleixo", "Cascata", "Gandé", "BNH", "Cachoeirinha"].map((area) => <span key={area} className="rounded-full border border-[#ead5c1] bg-white px-3 py-1.5 text-xs font-bold text-[#8b1e23]">{area}</span>)}</div><p className="mt-3 text-xs font-bold text-[#8b1e23]">Consulte a taxa de entrega pelo WhatsApp.</p></div></div></div></section>
      </main>
